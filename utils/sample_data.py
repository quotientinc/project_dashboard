    ...
    for emp_data in nia_allocations_data:
        for month_idx, month_date in enumerate(nia_months):
            ...
            allocation = {
                ...
                'allocation_percent': emp_data['fte_by_month'][month_idx],
                'allocation_date': month_date,
                'hours_projected': 0,  # Calculated by build_hours_sheet_data()
                'hours_actual': emp_data['actual_hours'][month_idx] if month_idx < len(emp_data['actual_hours']) else 0,
